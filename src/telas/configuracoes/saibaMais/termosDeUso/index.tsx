...
type ConfiguracoesTermosDeUsoProps = {
  onBack: () => void
}
...
function ConfiguracoesTermosDeUso({ onBack }: ConfiguracoesTermosDeUsoProps) {
  return (
      ...
      <article className="termos-config__article">
        ...
        <div className="termos-config__content">
          {SECOES_TERMOS.map((secao) => (
            <section className="termos-config__section" key={secao.titulo}>
              <h2>{secao.titulo}</h2>
              <p>{secao.texto}</p>
            </section>
          ))}
